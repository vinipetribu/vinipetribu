...
**Backend & Architecture:** Spring Boot, FastAPI, REST APIs, Domain-Driven Design (DDD), layered architecture  
**Data & ML:** Pandas, scikit-learn, SQL databases, MLflow, data pipelines, experiment tracking  
**Security:** OWASP Top 10, Web Pentesting fundamentals, HTTP request/response analysis, Burp Suite, authentication & authorization testing  
**DevOps & Tools:** Docker, Git/GitHub, DBeaver, Postman, VS Code, IntelliJ  
**Development Practices:** BDD (Cucumber), Scrum, Kanban, clean code principles  
...
- Storage in S3-compatible bucket
- Data processing with Pandas
- Model training and evaluation (classification models)
- Experiment tracking with MLflow
- Containerized environment with Docker Compose
- Reproducible pipeline structure
- Dashboard visualization with ThingsBoard

Focus: structured data pipeline, experiment reproducibility, model comparison and production-oriented workflow.
...
## 📚 Other Experience
- Teaching assistant/monitor in **Programming (C)** and **Algorithms & Data Structures**  
- Experience with code review, debugging, problem-solving and student support  
- Strong background in teamwork, planning and fast-response problem solving  

## 📫 Contact
**Email:** vinicius.petribu@gmail.com  
**LinkedIn:** https://linkedin.com/in/vinipetribu  
**GitHub:** https://github.com/vinipetribu  
